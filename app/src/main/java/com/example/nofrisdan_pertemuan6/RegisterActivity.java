package com.example.nofrisdan_pertemuan6;
...
public class RegisterActivity extends AppCompatActivity {
    ...
    public void SQLiteTableBuild() {
        sqLiteDatabaseObj.execSQL("CREATE TABLE IF NOT EXISTS " +
                        SQLiteHelper.TABLE_NAME + "(" + SQLiteHelper.Table_Column_ID + " INTEGER PRIMARY KEY AUTOINCREMENT, " + SQLiteHelper.Table_Column_1_Name + " VARCHAR, " + SQLiteHelper.Table_Column_2_Email + " VARCHAR, " + SQLiteHelper.Table_Column_3_Password + " VARCHAR);");
    }
    ...
    public void InsertDataIntoSQLiteDatabase(){
        if(EditTextEmptyHolder == true)
        {
            ...
            AlertDialog.Builder builder = new
                    AlertDialog.Builder(RegisterActivity.this); builder.setMessage("User Registered Successfully").setNegativeButton("OK",null).create().show();
        }
        else {
            // Messages Pop Up
            AlertDialog.Builder builder = new
